	...
	<div class="container">
		<form id="userRegisterForm" class="row g-3" action="${appRoot }/user/register" method="post">
			...
			<div class="col-12">
				...
				<div class="input-group mb-3">
					<input type="text" name="email" class="form-control" id="inputUserEmail" placeholder="주소를 정확히 입력해주세요! 가입인증 메일이 발송됩니다" aria-describedby="emailCheckButton" required>
